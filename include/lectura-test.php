...
<?php if ($tipo == 'test') {
  ...
  <div class='lectura'>
    <?php if ($tipoMuestra == 'lectura') {
      ?>
      <div class='titulo'>
        <?php echo $arrLect['titulo'] ?>
      </div>
      <?php if ($arrLect['subtitulo'] != '') {
        ?>
        <div class='subtitulo'>
          <?php echo $arrLect['subtitulo'] ?>
        </div>
      <?php }
      ?>
      <div class='texto'>
        <?php echo nl2br(trim($arrLect['texto'])) ?>
      </div>
      <div class='btn'>
        <div class='botonera'>

          <a class='cuestionario link-test' href='javascript:void(0)' title='Ir al Cuestionario'>Ir al Cuestionario</a>
        </div>
      </div>
    <?php }
    if ($tipoMuestra == 'preguntas') {
      ?>
      <div class='subtitulo'>CUESTIONARIO</div>
      <div class='titulo'>
        <?php echo $arrLect['titulo'] ?>
      </div>
      <?php if ($arrLect['subtitulo'] != '') {
      ...
      foreach ($arrClssPregs['result'] as $preguntasx) {
        ...
        <div id="preg<?php echo $cta ?>" class="pregunta <?php echo $ocultar ?>"> <?php echo $cta ?>.
          ...
          foreach ($arrClssAlt['result'] as $alternativasx) {
            ...
            ?>
            <label for="preg<?php echo $ctaAlt . "-" . $cta ?>"><input type='radio' id="preg<?php echo $ctaAlt . "-" . $cta ?>"
                name="preg<?php echo $ctaAlt ?>" value="<?php echo $ctaAlt ?>" />
              <span>
      ...
      <div class='ocultar' id='info-form'>
        <p> Para que puedas conocer tu resultado del Test, completa los siguientes datos con información
          real ya
          que el resultado se mostrara en pantalla y se enviará a la bandeja de entrada del EMAIL en los campos
          ...
          <div class='row'>
            <div class='form col-md-12'>
              <form name='formTest' id='formTest' method='post' action='include/ajax' class="row g-3">
                <div class="col-md-6">
                  <label class="form-label" for='nombreTest'>NOMBRE Y APELLIDO:</label>
                ...
                <div class="col-md-5 soyTestSelector soy_estudiante_colegio">
                  ...
                  <select name='semestreTest_soy_estudiante_colegio' id='semestreTest_soy_estudiante_colegio' class='required form-control' >
                ...
                <div class="col-md-7 soyTestSelector soy_estudiante_colegio">
                  ...
                  <input name='institucionTest_soy_estudiante_colegio' type='text' id='institucionTest_soy_estudiante_colegio' class='required form-control' />
                </div>
                ...
                <div class="col-md-4 soyTestSelector estudiante_universitario" style='display: none'>
                  ...
                  <input name='carreraTest_estudiante_universitario' type='text' id='carreraTest_estudiante_universitario' class='required form-control' />
                </div>
                <div class="col-md-4 soyTestSelector estudiante_universitario" style='display: none'>
                  <label class="form-label" for='institucionTest_estudiante_universitario'>INSTITUCIÓN:</label>
                  <input name='institucionTest_estudiante_universitario' type='text' id='institucionTest_estudiante_universitario' class='required form-control' />
                </div>
                ...
                <div class="col-md-6 soyTestSelector profesional" style='display: none'>
                  ...
                  <input name='carreraTest_profesional' type='text' id='carreraTest_profesional' class='required form-control' />
                </div>
                <div class="col-md-6 soyTestSelector profesional" style='display: none'>
                  <label class="form-label" for='institucionTest_profesional'>INSTITUCIÓN:</label>
                  <input name='institucionTest_profesional' type='text' id='institucionTest_profesional' class='required form-control' />
                </div>

                <div class="col-md-12">
                  <label class="form-label" for='comentarioTest'>COMENTARIO: </label>
                  <textarea name='comentarioTest' id='comentarioTest' rows="3" class="form-control"
                ...
                <input type='hidden' name='nomLecturaForm' id='nomLecturaForm' value="<?php echo $arrLect['titulo'] ?>" />
                <input type='hidden' name='cantPalabrasForm' id='cantPalabrasForm'
                  value="<?php echo $arrLect['cantidad_palabras'] ?>" />
                <input type='hidden' name='tipoPersonaForm' id='tipoPersonaForm' value='' />
                <input type='hidden' name='tipoTestForm' id='tipoTestForm' value='' />
                <input type='hidden' name='tiempoLecturaForm' id='tiempoLecturaForm' value='00:00' />
                ...
                <input type='hidden' name='tipo' value='lectura' />
                <div class='botonera'>
      ...
      <script>
        ...
        function showResponseTest(responseText) {
          ...
          if (obj['estado'] == 1) {
            ...
            var shareButton =
              '<div class="centrar"><br/><iframe width="81px" src="//www.facebook.com/plugins/like.php?href=' + currentURL +
              '&amp;width&amp;layout=box_count&amp;action=like&amp;show_faces=true&amp;share=false&amp;height=65&amp;appId=664328430259949" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:65px;" allowTransparency="true"></iframe></div>'
            $("#info-result").html(obj['mensaje'] + shareButton)
            $("#info-result").fadeIn();
          } else {
