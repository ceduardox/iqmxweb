...
<section class="content-header">
  ...
  <h1><i class="fa fa-video-camera"></i> Testimonios <small>Listado</small> </h1>
</section>
<?php
  ...
  <div class="box">
    <div class="box-body">
          ...
          <tbody>
            <?php foreach ($noticias as $row) {
              ...
              <tr>
                ...
                <td class="text-center"><a href="page-a_leer_bolivia_testimonio-<?php echo $row['id']; ?>"
                    title="ir a Editar" class="editar"><span>Editar</span></a></td>
                <td class="text-center"><a href="javascript:void(0)"
                    onclick="activate(<?php echo $row['id']; ?>, 'activateALeerBoliviaTestimonio', <?php echo $row['active']; ?>)"
                    title="<?php echo $activeLabel ?>" class="eliminar"><span><?php echo $activeLabel ?></span></a></td>
                <td class="text-center"><a href="javascript:void(0)"
                    onclick="eliminar(<?php echo $row['id']; ?>, 'eliminarALeerBoliviaTestimonio')" title="Eliminar"
      ...
      <div class="box-footer clearfix">
        <?php
        echo $Paginacion->pintarPaginas($paginas, $pagina, $total, $cantidad, 'page-a_leer_bolivia_testimonios');
        ?>
      <?php } else {
