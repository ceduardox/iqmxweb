  ...
  <section class="content">
    ...
    <div class="box ">
      ...
      <div class="box-body">
        ...
        <input type="hidden" value="guardarTestimonio" name="accion" />
      ...
      <div class="box-footer">
        ...
        <button type="button" onclick="javascript:location.href='page-testimonios'"  class="btn btn-default" id="btn-cancelar" name="cancelar"  >Volver</button>
