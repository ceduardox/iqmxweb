...
$pregunta = $cods[2];
$alternativa = $cods[3];
$dato = $cls->alternativa($alternativa,$pregunta,$serie);
...
<section class="content-header">
   <ol class="breadcrumb">
    ...
    <li><a href="page-test_iq_alternativas-<?php echo $tipo?>_<?php echo $serie?>_<?php echo $pregunta?>">Listado</a></li> 
    <li class="active">Editar</li>
  </ol>
  <h1><i class="fa fa-th-large"></i> Alternativa    </h1>
   <button type="button pull-left" onclick="javascript:location.href='page-test_iq_alternativas-<?php echo $tipo?>_<?php echo $serie?>_<?php echo $pregunta?>'"  class="btn btn-default" id="btn-cancelar" name="cancelar"  >Volver</button>
...
<form method="post" name="form_" id="form_" action="ajax" enctype="multipart/form-data" >
  <section class="content">
    <div class="box ">
      ...
      <div class="box-body">
        <input type="hidden" value="guardarTestiQAlternativa" name="accion" />
        <input type="hidden" value="<?php echo $alternativa ?>" name="cod" />
        <input type="hidden" value="<?php echo $pregunta ?>" name="serie_pregunta_id" /> 
      ...
      <div class="box-footer">
        ...
        <button type="button" onclick="javascript:location.href='page-test_iq_alternativas-<?php echo $tipo?>_<?php echo $serie?>_<?php echo $pregunta?>'"  class="btn btn-default" id="btn-cancelar" name="cancelar"  >Volver</button>
