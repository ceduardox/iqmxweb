  ...
  <div class="box">
    <div class="box-body">
          ...
          <tbody>
            <?php foreach ($rows as $row) {
              ...
              <tr>
                ...
                <td class="text-center"><a href="page-push-notification-message-enviar-<?php echo $row['id']; ?>"
                    title="ir a Enviar" class="enviar"><span>Enviar</span></a></td>
                <td class="text-center"><a href="page-push-notification-message-<?php echo $row['id']; ?>"
      ...
      <div class="box-footer clearfix">
        <?php
        echo $Paginacion->pintarPaginas($paginas, $pagina, $total, $cantidad, 'page-push-notification-messages');
        ?>
      <?php } else {
