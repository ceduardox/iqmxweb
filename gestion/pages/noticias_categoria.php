...
$cls = new ClssNoticia();
$cod = (isset($cod)) ? $cod : 0;
$dato = $cls->getCategoriaNoticia($cod);
if ($cod == 0) {
    $dato[0]['nombre'] = '';
}
  ...
  <section class="content">
    <div class="box ">
      <div class="box-header with-border">
        <h3 class="box-title">Datos de la etiqueta</h3>
      </div>
      <div class="box-body">
        <input type="hidden" value="guardarCategoria" name="accion" />
      ...
      <div class="box-footer">
        ...
        <button type="button" onclick="javascript:location.href='page-noticias_categorias'"  class="btn btn-default" id="btn-cancelar" name="cancelar"  >Volver</button>
