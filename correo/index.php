...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0;font-family:'Inter',Segoe UI,Tahoma,Geneva,Verdana,sans-serif}
    ...
    .sidebar{position:sticky;top:20px;padding:24px 16px;height:auto;overflow:visible;background:#0b0f19;border:1px solid #1e293b;border-radius:12px;display:flex;flex-direction:column;justify-content:space-between;scrollbar-width:none;-ms-overflow-style:none;align-self:start}
    ...
    .sidebar .brand{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;padding:14px 14px 18px;border:1px solid #16263a;border-radius:14px;background:linear-gradient(180deg,rgba(11,15,25,.95),rgba(17,24,39,.72));box-shadow:inset 0 1px 0 rgba(255,255,255,.03)}
        ...
        <aside class="sidebar">
          <div class="sidebar-top-content">
            ...
            <div class="section">
              ...
              <div class="nav">
                <button class="tab active" data-tab="inbox" type="button"><span>Recibidos</span></button>
