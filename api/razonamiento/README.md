...
**Endpoint:** `/api/razonamiento/listarLectura`
...
- **Example Request:** `/api/razonamiento/listarLectura?cod=1&categoria=2&subcategoria=3`
...
**Endpoint:** `/api/razonamiento/listarSubCategoria`
...
- **Example Request:** `/api/razonamiento/listarSubCategoria?cod=1&categoria=2`
...
**Endpoint:** `/api/razonamiento/listarCategoria`
...
- **Example Request:** `/api/razonamiento/listarCategoria?cod=1&slug=example`
...
**Endpoint:** `/api/razonamiento/listarPregunta`
...
- **Example Request:** `/api/razonamiento/listarPregunta?cod=1&lectura=2`
...
**Endpoint:** `/api/razonamiento/listarAlternativas`
...
- **Example Request:** `/api/razonamiento/listarAlternativas?cod=1&pregunta=2`
